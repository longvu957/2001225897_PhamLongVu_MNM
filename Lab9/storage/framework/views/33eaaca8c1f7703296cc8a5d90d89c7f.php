...
<?php endif; ?>
            ...
            <?php else: ?>
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-700 underline">Đăng nhập</a>
                <a href="<?php echo e(route('register')); ?>" class="ml-4 text-sm text-gray-700 underline">Đăng ký</a>
            </div>
            <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('articles.index'),'active' => request()->routeIs('articles.*')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH C:\Users\ADMIN\Downloads\php\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>